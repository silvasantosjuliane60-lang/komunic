...
export const GAME_METADATA: Record<string, GameMetadata> = {
  ...
  raciocinio: {
    id: 'KMK-0012',
    titulo: 'Desafio Lógico',
    emoji: '🧠',
    categoria: 'Raciocínio Lógico',
    modulo: 'Cognição e Pensamento',
    nivel: 2,
    idade: '4–8 anos',
    bncc: ['EI03ET01', 'EI03ET02', 'EI03CG05'],
    objetivo: 'Desenvolver padrões, sequências e associações lógicas',
    descricao: 'A criança resolve 5 desafios de lógica: sequências, intruso, sombras e associações!',
    competencias: [
      { emoji: '💡', label: 'Pensamento Lógico',   color: '#3F51B5' },
      { emoji: '🧠', label: 'Raciocínio',           color: '#B983FF' },
      { emoji: '⚡', label: 'Atenção',               color: '#FFC312' },
      { emoji: '🔍', label: 'Pensamento Crítico',  color: '#C44569' },
    ],
    pontuacao: 15,
    recompensa: '🧠 Medalha do Gênio',
    audio: true,
    animacao: true,
    inclusao: 'Narração em áudio de cada desafio',
    hudColor: ['#FFC312', '#F79F1F', '#EE5A24'],
  },
  ...
  matematica: {
    ...
    emoji: '🧮',
    categoria: 'Matemática Lúdica',
    modulo: 'Cognição e Números',
    nivel: 2,
    idade: '4–8 anos',
    bncc: ['EI03ET06', 'EI03ET07', 'EI03ET08'],
    objetivo: 'Desenvolver noções de número, quantidade, tamanho e sequência',
    descricao: 'A criança pratica antecessor/sucessor, maior/menor e contagem com desafios visuais e divertidos!',
    competencias: [
      { emoji: '🔢', label: 'Pensamento Numérico', color: '#009432' },
      { emoji: '📊', label: 'Comparação',          color: '#12CBC4' },
      { emoji: '🧠', label: 'Raciocínio',           color: '#B983FF' },
      { emoji: '⚡', label: 'Atenção',               color: '#FFC312' },
    ],
    pontuacao: 15,
    recompensa: '🧮 Calculadora',
    audio: true,
    animacao: true,
    inclusao: 'Narração em áudio de cada desafio',
    hudColor: ['#009432', '#12CBC4', '#4D96FF'],
